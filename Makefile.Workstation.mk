...
ubuntu-setup-packages:
	...
	sudo apt install -y git make wget curl jq qemu-utils cloud-guest-utils cloud-init virtualbox vagrant cloud-utils build-essential vim virtualbox vagrant libvirt-daemon-system libvirt-clients qemu-kvm libvirt-daemon bridge-utils virt-manager libguestfs-tools libosinfo-bin libguestfs-tools virt-top virtinst libvirt-doc wget curl jq make zsh git libz-dev vim vim-gtk3 gnome-terminal gnome-tweaks gnome-shell-extensions gnome-shell-extension-ubuntu-dock
